...
public class Gerador extends ProdutoWeg {
	...
	public Gerador(int codigo, String tipo, double potencia, double tensao, int capacidade, double preco, String combustivel) {
		super(codigo, tipo, potencia, tensao, capacidade, preco);
		setCombustivel(combustivel);
	}
	public Gerador(int codigo, String tipo, double potencia, double tensao, int capacidade, double preco, String combustivel, double autonomia) {
		super(codigo, tipo, potencia, tensao, capacidade, preco);
		setCombustivel(combustivel);
