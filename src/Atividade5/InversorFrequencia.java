...
public class InversorFrequencia extends ProdutoWeg {
	...
	public InversorFrequencia(int codigo, String tipo, double potencia, double tensao, int capacidade, double preco, double capFreq) {
		super(codigo, tipo, potencia, tensao, capacidade, preco);
		setCapFreq(capFreq);
	}
	public InversorFrequencia(int codigo, String tipo, double potencia, double tensao, int capacidade, double preco, double capFreq, int numeroFases) {
		super(codigo, tipo, potencia, tensao, capacidade, preco);
		setCapFreq(capFreq);
