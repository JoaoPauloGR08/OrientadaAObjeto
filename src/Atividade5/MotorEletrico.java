...
public class MotorEletrico extends ProdutoWeg {
	...
	public MotorEletrico(int codigo, String tipo, double potencia, double tensao, int capacidade, double preco, String tipoRolamento) {
		super(codigo, tipo, potencia, tensao, capacidade, preco);
		setTipoRolamento(tipoRolamento);
	}
	public MotorEletrico(int codigo, String tipo, double potencia, double tensao, int capacidade, double preco, String tipoRolamento, double eficiencia) {
		super(codigo, tipo, potencia, tensao, capacidade, preco);
		setTipoRolamento(tipoRolamento);
